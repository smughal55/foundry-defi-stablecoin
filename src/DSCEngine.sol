...
contract DSCEngine is ReentrancyGuard {
    ...
    {
        // if redeeming collateral (all) first, then the health factor will be broken e.g. $100 ETH -> $20 DSC, 100 (break)
        // if burning DSC first, then the health factor will be ok
        ...
        nonReentrant
    {
        ...
        // $100 ETH backing $50 DSC - OK
        // ETH drops to $20 ETH backing $50 DSC - NOT OK as we are undercollateralized, isn't worth $1!!!

        // $75 backing $50 DSC
        // Liquidator gets $75 of collateral and burns $50 DSC
        ...
        // And give them a 10% bonus as if it's just a 1:1, they won't be incentivized to liquidate
        // So we are giving the liquidator $110 of WETH for 100 DSC
        // We should implement a feature to liquidate in the event the protocol is insolvent
        // And sweep extra amounts into a treasury

        // 0.05 ETH * 0.1 = 0.005 ETH, Liquidator gets 0.005 ETH bonus > 0.055 ETH total
        ...
        // revert if the liquidator's health factor is broken as a result of the liquidation
        _revertIfHealthFactorIsBroken(msg.sender);
    }
    ...
    */
    ...
    function _calculateHealthFactor(uint256 totalDscMinted, uint256 collateralValueInUsd)
        ...
        returns (uint256)
    {
        if (totalDscMinted == 0) return type(uint256).max; // since if the user has no DSC (debt), we'd divide by 0 below
        // $1000 ETH * 50 = 50,000 / 100 = 500
        // $150 ETH / 100 DSC = 1.5
        // 150 * 50  = 7500 / 100 = 75, then (75 / 100) < 1, user is liquidatable as they need double the collateral

        // $1000 ETH (deposited) / 100 DSC (minted)
        // 1000 * 50 = 50,000 / 100 = 500, then (500 / 100) > 1, user is not liquidatable
